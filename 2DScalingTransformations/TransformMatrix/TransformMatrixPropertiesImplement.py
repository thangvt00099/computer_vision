...
if __name__ == '__main__':
    ...
    # Tính ma trận nghịch đảo và ma trận chuyển vị
    print("Ma trận nghịch đảo: ", np.linalg.inv(R))
    print("Ma trận chuyển vị: ", R.T)
    print("==========================")
    # Tính ma trận Reflection
    Rf = R[[1, 0], :]
    print(Rf)

    # Det của Rf
    detRf = np.linalg.det(Rf)
    print(detRf)
    print(Rf.T)
    print(np.linalg.inv(Rf))
