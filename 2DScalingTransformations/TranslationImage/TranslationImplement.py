...
if __name__ == '__main__':
    ...
    #
    # T = np.array([[cos_a, -sin_a, 5], [sin_a, cos_a, 5], [0, 0, 1]])
    ...
    cv2.imwrite(r"C:\Users\DELL INSPIRON 5530\PycharmProjects\PythonProject\OpenCV\Img\albert_einstein_affine.jpg", I2)
